...
namespace MamuzApplicationTest\Filter;

use MamuzApplication\Filter\MailMessage;
...
class MailMessageTest extends \PHPUnit_Framework_TestCase
{
    ...
    /** @var \MamuzApplication\Options\MailInterface|\Mockery\MockInterface */
    protected $options;
    ...
    protected function setUp()
    {
        ...
        $this->options = \Mockery::mock('MamuzApplication\Options\MailInterface');
