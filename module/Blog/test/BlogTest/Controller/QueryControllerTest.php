...
class QueryControllerTest extends \PHPUnit_Framework_TestCase
{
    ...
    /** @var \Blog\Crypt\AdapterInterfacee | \Mockery\MockInterface */
    ...
    {
        $this->cryptEngine = \Mockery::mock('Blog\Crypt\AdapterInterface');
        $this->queryInterface = \Mockery::mock('Blog\Feature\QueryInterface');
